...
namespace Lab06_AlexandroCano.Services
{
    public class AuthService : IAuthService
    {
        ...
        public async Task<(bool success, string message, int? userId)> RegisterAsync(RegisterDto dto, string forcedRole)
        {
            ...
            var user = new User
            {
                ...
                Role = forcedRole, // El rol lo impone el controlador, no el DTO
